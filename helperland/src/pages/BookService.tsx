...
const BookService = () => {
  ...
  const checkAvailibility = () => {
    getPostalCode(postalCode).then((data) => {
      if (data.error) {
            ...
            <div style={{ maxWidth: "750px", margin: "0 auto" }}>
              ...
              >
                <StyledTab
                  icon={
                    value === 0 ? (
                      <img src={setupServiceWhite} />
                    ) : (
                      <img src={setupService} />
                    )
                  }
                  iconPosition="start"
                  label="Setup Service"
                ...
                <StyledTab
                  ...
                  {...a11yProps(1)}
                  className="tab"
                  disabled={isSecondActive ? false : true}
                />
                <StyledTab
                  icon={
                    value === 2 ? (
                      <img src={detailsWhite} />
                    ) : (
                      <img src={details} />
                    )
                  }
                  ...
                  {...a11yProps(2)}
                  className="tab"
                  disabled={isThirdActive ? false : true}
                />
                <StyledTab
                  icon={
                    value === 3 ? (
                      <img src={paymentWhite} />
                    ) : (
                      <img src={payment} />
                    )
                  }
                  ...
                  {...a11yProps(3)}
                  className="tab"
                  disabled={isForthActive ? false : true}
                />
              </StyledTabs>
                ...
                <form onSubmit={handleSubmit(storeScheduleData)}>
                  <div className="book-service-left">
                    <div className="room-count">
                      ...
                      >
                        <MenuItem onClick={() => handleBedChange(1)} value={1}>
                          1 &nbsp;&nbsp;bed
                        </MenuItem>
                        <MenuItem onClick={() => handleBedChange(2)} value={2}>
                          2 &nbsp;&nbsp;bed
                        </MenuItem>
                        <MenuItem onClick={() => handleBedChange(3)} value={3}>
                          3 &nbsp;&nbsp;bed
                        </MenuItem>
                      </CustomSelect>
                      ...
                      <CustomSelect
                        ...
                        inputProps={{ "aria-label": "Without label" }}
                      >
                        <MenuItem onClick={() => handleBathChange(1)} value={1}>
                          1 &nbsp;&nbsp;bath
                        </MenuItem>
                        <MenuItem onClick={() => handleBathChange(2)} value={2}>
                          2 &nbsp;&nbsp;bath
                        </MenuItem>
                        <MenuItem onClick={() => handleBathChange(3)} value={3}>
                          3 &nbsp;&nbsp;bath
                        </MenuItem>
                      </CustomSelect>
                    </div>
                    ...
                    <Grid
                      container
                      className="extra-services service-center"
                      pt={1}
                      pb={1.5}
                    >
                      <Grid
                        ...
                        xs={12}
                        md={4}
                        className="extra-services-item cabinet-checkbox"
                      >
                        <input
                          type="checkbox"
                          name="cabinet"
                      ...
                      <Grid
                        ...
                        xs={12}
                        md={4}
                        className="extra-services-item fridge-checkbox"
                      >
                        <input
                          type="checkbox"
                          name="fridge"
                      ...
                      <Grid
                        ...
                        xs={12}
                        md={4}
                        className="extra-services-item oven-checkbox"
                      >
                        <input
                          type="checkbox"
                          name="oven"
                      ...
                      <Grid
                        ...
                        xs={12}
                        md={6}
                        className="extra-services-item machine-checkbox"
                      >
                        <input
                          type="checkbox"
                          name="machine"
                        ...
                        <p className="service-name laundry-wash">
                          Laundry wash & dry
                        </p>
                      </Grid>
                      <Grid
                        ...
                        xs={12}
                        md={6}
                        className="extra-services-item window-checkbox"
                      >
                        <input
                          type="checkbox"
                          name="window"
                        ...
                        <p className="service-name interior-windows">
                          Interior windows
                        </p>
                      </Grid>
                    </Grid>
              ...
              <TabPanel value={value} index={2}>
                <div className="details">
                    ...
                    {addressObj &&
                      addressObj.map((user, i) => (
                        <CustomFormControlRadio
                          ...
                          value={i++}
                          control={<Radio />}
                          label={`Address : ${user.streetName} ${user.houseNumber} , ${user.city}  ${user.zipCode}     
                      ...
                      <form onSubmit={handleSubmit4(saveAddress)}>
                        <Grid container spacing={2} sx={{ mb: 2 }}>
                          <Grid item lg={6}>
                            ...
                            />
                            {errors4.streetName &&
                              errors4.streetName.type === "required" && (
                                <p className="error">Street name is required</p>
                              )}
                            {errors4.streetName &&
                              errors4.streetName.type === "minLength" && (
                                <p className="error">Min length should be 3</p>
                              )}
                          </Grid>
                          <Grid item lg={6}>
                        ...
                        <Grid container spacing={2} sx={{ mb: 2 }}>
                          ...
                          <Grid item lg={6}>
                            ...
                            />
                            {errors4.city &&
                              errors4.city.type === "required" && (
                                <p className="error">City name is required</p>
                              )}
                            {errors4.city &&
                              errors4.city.type === "minlength" && (
                                <p className="error">
                        ...
                        <Grid container spacing={2} sx={{ mb: 2 }}>
                          <Grid item lg={6}>
                            ...
                            {errors4.mobileNumber &&
                              errors4.mobileNumber.type === "required" && (
                                <p className="error">
                                  Mobile number is required
                                </p>
                              )}
                            {errors4.mobileNumber &&
                              errors4.mobileNumber.type === "minLength" && (
                                <p className="error">
                                  Mobile number is invalid
                                </p>
                              )}
                            {errors4.mobileNumber &&
                              errors4.mobileNumber.type === "maxLength" && (
                                <p className="error">
                                  Mobile number is invalid
                                </p>
                              )}
                            {errors4.mobileNumber &&
                              errors4.mobileNumber.type === "pattern" && (
                                <p className="error">
                                  Must start with valid number
                                </p>
                              )}
                          </Grid>
                        </Grid>
                        <Grid container spacing={2}>
                          <Grid item lg={12}>
                            ...
                            <CustomButton2 onClick={handleCloseAddress}>
                              Cancel
                            </CustomButton2>
                          </Grid>
                        </Grid>
                  ...
                  {!showAddress && (
                    <AddressButton onClick={handleOpenAddress}>
                      + Add New Address
                    </AddressButton>
                  )}
                  <CustomButton onClick={yourDetailsDone}>
                    Continue
                  </CustomButton>
                </div>
              </TabPanel>
              ...
              <TabPanel value={value} index={3}>
                <form onSubmit={handleSubmit(submitForm)}>
                  ...
                  />
                  {errors5.agreement &&
                    errors5.agreement.type === "required" && (
                      <p className="error">errors5.agreement.message</p>
                    )}
                ...
                <div className="payment-summery-details">
                  {isSecondActive && (
                    <div className="room-details">
                      <p>
                        {date?.toDateString()} @ {time} <br /> {bed} bed, {bath}{" "}
                        bath.
                      </p>
                    </div>
                  )}
                  ...
                  <div className="payment-duration-details total-payment">
                    ...
                    <Typography component="h4" variant="h2" className="pay">
                      ${isSecondActive ? totalPayment() : 0}
                    </Typography>
                  </div>
                  ...
                  >
                    ...
                    <AccordionDetails className="sidebar-accordion-details">
                      <p>
                        ...
                        elit. Ab sed nesciunt inventore labore facilis illum
                        accusamus sapiente asperiores culpa voluptatum. Ullam
                        provident quam possimus nulla, ipsam praesentium minus
                        omnis esse!
                      </p>
                    </AccordionDetails>
                  </Accordion>
