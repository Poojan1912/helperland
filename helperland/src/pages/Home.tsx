          ...
          <Grid container>
            <Grid item xs={12} lg={4} textAlign="center">
              <Card sx={{ maxWidth: 320, boxShadow: "none", marginX: "auto" }}>
                <CardMedia component="img" image={group21} alt="group-21" />
                <CardContent sx={{ p: 0 }}>
                  <Typography
                    gutterBottom
                    variant="h3"
                  ...
                  <Typography variant="body1" mt={3.6} fontSize="17px">
                    We want you to be completely satisfied with our service and
                    feel comfortable at home. In order to guarantee this, our
                    helpers go through a test procedure. Only when the cleaners
                    meet our high standards, they may call themselves Helper.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={12} lg={4} textAlign="center">
              <Card sx={{ maxWidth: 320, boxShadow: "none", marginX: "auto" }}>
                <CardMedia component="img" image={group23} alt="group-22" />
                <CardContent sx={{ p: 0 }}>
                  <Typography
                    gutterBottom
                    variant="h3"
                  ...
                  <Typography variant="body1" mt={4} fontSize="17px">
                    We have transparent prices, you do not have to scratch money
                    on the sideboard Leave it: Pay your helper easily and secure
                    via the online payment method. You will also receive an
            ...
            <Grid item xs={12} lg={4} textAlign="center">
              <Card sx={{ maxWidth: 320, boxShadow: "none", marginX: "auto" }}>
                <CardMedia component="img" image={group24} alt="group-23" />
                <CardContent sx={{ p: 0 }}>
                  <Typography
                    sx={{ lineHeight: "53px" }}
                    gutterBottom
                  ...
                  <Typography variant="body1" mt={6} fontSize="17px">
                    You have a question or need assistance with the booking
                    process? Our customer service is happy to help and advise
                    you. How you can reach us you will find out when you look
                    under &ldquo;Contact&rdquo;. We look forward to hearing from
                    you or reading.
                  </Typography>
                </CardContent>
              </Card>
        ...
        <Container maxWidth="xl">
          <Grid container sx={{ px: 0, display: "flex", alignItems: "center" }}>
            ...
            >
              ...
              <Typography
                variant="body1"
                sx={{ fontSize: 18, color: "#4F4F4F" }}
              >
                If it&apos;s not dusting off, our friendly helpers will free you
                from this burdon - do not worry anymore about spending valuable
                time doing housework, but savor life, you&apos;re well worth
                your time with beautiful experiences. Free yourself and enjoy
                the gained time: Go celebrate, relax, play with your children,
                meet friends or dare to jump on the bungee. Other leisure ideas
                and exclusive events can be found in our blog - guaranteed free
                from dust and cleaning tips!
              </Typography>
            </Grid>
          ...
          <Container maxWidth="xl">
            ...
            <Grid container className="blog-items">
              <Grid item lg={4} xs={12}>
                <Card
                  sx={{
                    ...
                    mb: 5.5,
                    mx: "auto",
                    boxShadow: "0 0 30px #e4ebf0",
                  }}
                >
                  <CardMedia component="img" image={group28} alt="blog-1" />
              ...
              <Grid item lg={4} xs={12}>
                ...
                >
                  <CardMedia component="img" image={group29} alt="blog-1" />
              ...
              <Grid item lg={4} xs={12}>
                ...
                >
                  <CardMedia component="img" image={group30} alt="blog-1" />
                  <CardContent sx={{ pl: 2.5, pt: 2 }}>
                    <Typography
                      gutterBottom
                      variant="h4"
