...
const userNameValues = ["Lyum Watson", "John Smith"];
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <StyledTableHead>
                <StyledTableRowHeader>
                  ...
                  <StyledTableCell className="white-space-wrap" align="center">
                    Actions
                  </StyledTableCell>
                </StyledTableRowHeader>
              </StyledTableHead>
              <StyledTableBody>
                {tableRows.map((row, index) => (
                  ...
                  >
                    ...
                    <StyledTableCell className="white-space-wrap">
                      {row.radius !== 0 && <p>{row.radius} km</p>}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      ...
                      {row.userStatus === "Inactive" && (
                        <p className="user-status user-inactive-status">
                          Inactive
                        </p>
                      )}
                    </StyledTableCell>
