...
const Address = (props: addressProps) => {
  ...
  const deleteAddress = () => {
    deleteAddressData(email, addressId).then((data) => {
      if (data.error) {
        console.log(data.error);
      } else {
        console.log(data);
    ...
    <div>
          ...
          <form onSubmit={handleSubmit2(saveAddress)}>
            ...
            <Grid container spacing={2}>
              <Grid item lg={6}>
                ...
                />
                {errors2.streetName && !streetName && (
                  <p className="error">{errors2.streetName.message}</p>
                )}
              </Grid>
              ...
              <Grid item lg={6}>
                ...
                />
                {errors2.houseNumber && !houseNumber && (
                  <p className="error">{errors2.houseNumber.message}</p>
                )}
              </Grid>
              ...
              <Grid item lg={6}>
                ...
                />
                {errors2.zipCode && !zipCode && (
                  <p className="error">{errors2.zipCode.message}</p>
                )}
              </Grid>
              ...
              <Grid item lg={6}>
                ...
                />
                {errors2.city && !city && (
                  <p className="error">{errors2.city.message}</p>
                )}
              </Grid>
              ...
              <Grid item lg={6}>
                ...
                />
                {errors2.mobilenumber && !mobilenumber && (
                  <p className="error">{errors2.mobilenumber.message}</p>
                )}
              </Grid>
            </Grid>
            <UpdateButton type="submit">Save</UpdateButton>
      ...
      <TableContainer>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          ...
          <StyledTableBody>
            {addressDetails &&
              addressDetails.map((dataItem, index) => (
                <StyledTableRow sx={{ cursor: "auto" }} key={index}>
                  <StyledTableCell align="left">
                    <span className="address-details">
                      <p>Address:&nbsp;</p>
                      {dataItem.streetName} {dataItem.houseNumber},{" "}
                      {dataItem.zipCode} {dataItem.city}
                    </span>
                    <span className="address-details">
                      <p>Phone number:&nbsp;</p>
                  ...
                  <StyledTableCell align="center">
                    ...
                    <RippleButton onClick={deleteAddress}>
