...
const ServiceHistory = () => {
  ...
  useEffect(() => {
    serviceHistory(email).then((data) => {
      if (data.error) {
          ...
          <StyledTableBody>
            ...
            >
              <Box className="modal service-details-modal">
                ...
                <hr />
                <div style={{ display: "flex", alignItems: "center" }}>
                  <p className="modal-title" style={{ width: "200px" }}>
                    On time arrival:
                  </p>
            ...
            {serviceHistoryData &&
              serviceHistoryData.map((dataItem) => (
                <StyledTableRow
                  sx={{ cursor: "auto" }}
                ...
                >
                  ...
                  <StyledTableCell align="center">
                    {dataItem.status === "Completed" && (
                      <p className="service-status">{dataItem.status}</p>
                    )}

                    {(dataItem.status === "Cancelled" ||
                      dataItem.status === "Refunded") && (
