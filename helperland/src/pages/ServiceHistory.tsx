      ...
      <Container maxWidth="xl">
        <div className="service-row">
          <div className="service-sidebar menu-toggle" id="serviceSidebar">
            <ul>
              <li onClick={() => handleChange(sidebarData[0])}>
                {sidebarData[0]}
              </li>
              <li onClick={() => handleChange(sidebarData[1])}>
                {sidebarData[1]}
              </li>
              <li onClick={() => handleChange(sidebarData[2])}>
                {sidebarData[2]}
              </li>
              <li onClick={() => handleChange(sidebarData[3])}>
                {sidebarData[3]}
              </li>
              <li onClick={() => handleChange(sidebarData[4])}>
                {sidebarData[4]}
              </li>
              <li onClick={() => handleChange(sidebarData[5])}>
                {sidebarData[5]}
              </li>
            </ul>
          </div>
          ...
          <div className="service-table">
                  ...
                  {rows.map((row, index) => (
                    ...
                    >
                      <StyledTableCell align="left">
                        ...
                        <div className="service-time">{row.serviceTime}</div>
                      </StyledTableCell>
                      <StyledTableCell align="left">
                      ...
                      <StyledTableCell align="center">
                        <StyledButton>Rate SP</StyledButton>
                      </StyledTableCell>
                    </StyledTableRow>
                  ))}
                </StyledTableBody>
            ...
            <div className="table-pagination">
              <div>
                ...
                >
                  <MenuItem
                    onClick={() => handlePaginationChange(10)}
                    value={10}
                  >
                    10
                  </MenuItem>
                  <MenuItem
                    onClick={() => handlePaginationChange(20)}
                    value={20}
                  >
                    20
                  </MenuItem>
                  <MenuItem
                    onClick={() => handlePaginationChange(30)}
                    value={30}
                  >
                    25
                  </MenuItem>
